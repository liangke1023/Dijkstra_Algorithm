...
// Graph Class
// Portray a Graph through an adjacency list
class Graph
{
  public:
    Graph();
...
{
  // Create nodes and connect it to default names (0..51 -> A..Za..z)
  numV = numVertices;
  numE = 0;
  ...
  // Create adjacency list with all nodes and vacant edge list
  adjList.clear();
...
// Used to keep information about nodes, paths and min dists in priority queue
struct strNodeInfo
{
...
// Return true if two NodeInfo have similar nodeName and false otherwise
